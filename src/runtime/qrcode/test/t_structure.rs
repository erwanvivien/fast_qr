...
fn structure_codewords_data() {
    const VERSION: crate::runtime::qrcode::version::Version =
        crate::runtime::qrcode::version::Version::V05;
    const QUALITY: crate::runtime::qrcode::ecl::ECL = crate::runtime::qrcode::ecl::ECL::Q;
...
fn structure_codewords_binary_repr() {
    ...
    assert_eq!(
        crate::runtime::qrcode::helpers::binary_to_binarystring_version(structure, VERSION, QUALITY)
        .as_string(),
...
fn structure_codewords_seed_27() {
    const VERSION: crate::runtime::qrcode::version::Version =
        crate::runtime::qrcode::version::Version::V10;
    const QUALITY: crate::runtime::qrcode::ecl::ECL = crate::runtime::qrcode::ecl::ECL::Q;
...
fn structure_codewords_seed_31() {
    const VERSION: crate::runtime::qrcode::version::Version =
        crate::runtime::qrcode::version::Version::V07;
    const QUALITY: crate::runtime::qrcode::ecl::ECL = crate::runtime::qrcode::ecl::ECL::H;
...
fn structure_codewords_seed_51() {
    const VERSION: crate::runtime::qrcode::version::Version =
        crate::runtime::qrcode::version::Version::V16;
    const QUALITY: crate::runtime::qrcode::ecl::ECL = crate::runtime::qrcode::ecl::ECL::M;
...
fn structure_codewords_seed_57() {
    const VERSION: crate::runtime::qrcode::version::Version =
        crate::runtime::qrcode::version::Version::V03;
    const QUALITY: crate::runtime::qrcode::ecl::ECL = crate::runtime::qrcode::ecl::ECL::Q;
...
fn placement() {
    ...
    let mut bs = crate::runtime::qrcode::bitstring::BitString::new();
    ...
    let mat_full = crate::runtime::qrcode::default::non_available_matrix_from_version(version);

    crate::runtime::qrcode::placement::test_place_on_matrix_data(&mut mat, &bs, &mat_full);
