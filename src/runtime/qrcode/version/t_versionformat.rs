use crate::runtime::qrcode::QRCode;

#[test]
fn version_format_l_mask0() {
    const CONTENT: &str = "4";
    const MASK: Option<usize> = Some(0);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V05);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::L);

    let q: QRCode = QRCode::new(CONTENT.as_bytes(), LEVEL, VERSION, MASK);
    ...
    if let crate::runtime::qrcode::QRCode::V05(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
...
fn version_format_l_mask1() {
    ...
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V03);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::L);
    ...
    if let crate::runtime::qrcode::QRCode::V03(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
            mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_l_mask2() {
    ...
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V06);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::L);
    ...
    if let crate::runtime::qrcode::QRCode::V06(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
            mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_m_mask0() {
    ...
    const MASK: Option<usize> = Some(0);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V01);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::M);
    ...
    if let crate::runtime::qrcode::QRCode::V01(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_m_mask1() {
    ...
    const MASK: Option<usize> = Some(1);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V04);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::M);
    ...
    if let crate::runtime::qrcode::QRCode::V04(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_m_mask2() {
    ...
    const MASK: Option<usize> = Some(2);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V02);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::M);
    ...
    if let crate::runtime::qrcode::QRCode::V02(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_q_mask0() {
    ...
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V04);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::Q);
...
fn version_format_h_mask0() {
    ...
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V06);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::H);
...
fn version_format_l_mask0_version23() {
    ...
    const MASK: Option<usize> = Some(0);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V23);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::L);
    ...
    if let crate::runtime::qrcode::QRCode::V23(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_l_mask1_version29() {
    ...
    const MASK: Option<usize> = Some(1);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V29);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::L);
    ...
    if let crate::runtime::qrcode::QRCode::V29(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_l_mask2_version40() {
    ...
    const MASK: Option<usize> = Some(2);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V40);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::L);
    ...
    if let crate::runtime::qrcode::QRCode::V40(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_l_mask3_version8() {
    ...
    const MASK: Option<usize> = Some(3);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V08);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::L);
    ...
    if let crate::runtime::qrcode::QRCode::V08(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_l_mask4_version36() {
    ...
    const MASK: Option<usize> = Some(4);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V36);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::L);
    ...
    if let crate::runtime::qrcode::QRCode::V36(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_l_mask5_version22() {
    ...
    const MASK: Option<usize> = Some(5);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V22);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::L);
    ...
    if let crate::runtime::qrcode::QRCode::V22(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_l_mask6_version10() {
    ...
    const MASK: Option<usize> = Some(6);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V10);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::L);
    ...
    if let crate::runtime::qrcode::QRCode::V10(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_l_mask7_version17() {
    ...
    const MASK: Option<usize> = Some(7);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V17);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::L);
    ...
    if let crate::runtime::qrcode::QRCode::V17(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_m_mask0_version14() {
    ...
    const MASK: Option<usize> = Some(0);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V14);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::M);
    ...
    if let crate::runtime::qrcode::QRCode::V14(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_m_mask1_version30() {
    ...
    const MASK: Option<usize> = Some(1);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V30);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::M);
    ...
    if let crate::runtime::qrcode::QRCode::V30(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_m_mask2_version37() {
    ...
    const MASK: Option<usize> = Some(2);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V37);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::M);
    ...
    if let crate::runtime::qrcode::QRCode::V37(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_m_mask4_version31() {
    ...
    const MASK: Option<usize> = Some(4);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V31);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::M);
    ...
    if let crate::runtime::qrcode::QRCode::V31(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_m_mask5_version13() {
    ...
    const MASK: Option<usize> = Some(5);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V13);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::M);
    ...
    if let crate::runtime::qrcode::QRCode::V13(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_m_mask7_version7() {
    ...
    const MASK: Option<usize> = Some(7);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V07);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::M);
    ...
    if let crate::runtime::qrcode::QRCode::V07(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_q_mask0_version20() {
    ...
    const MASK: Option<usize> = Some(0);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V20);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::Q);
    ...
    if let crate::runtime::qrcode::QRCode::V20(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_q_mask1_version33() {
    ...
    const MASK: Option<usize> = Some(1);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V33);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::Q);
    ...
    if let crate::runtime::qrcode::QRCode::V33(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_q_mask2_version24() {
    ...
    const MASK: Option<usize> = Some(2);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V24);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::Q);
    ...
    if let crate::runtime::qrcode::QRCode::V24(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_q_mask3_version18() {
    ...
    const MASK: Option<usize> = Some(3);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V18);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::Q);
    ...
    if let crate::runtime::qrcode::QRCode::V18(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_q_mask6_version11() {
    ...
    const MASK: Option<usize> = Some(6);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V11);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::Q);
    ...
    if let crate::runtime::qrcode::QRCode::V11(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_q_mask7_version15() {
    ...
    const MASK: Option<usize> = Some(7);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V15);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::Q);
    ...
    if let crate::runtime::qrcode::QRCode::V15(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
...
fn version_format_h_mask0_version35() {
    ...
    const MASK: Option<usize> = Some(0);
    const VERSION: Option<crate::runtime::qrcode::version::Version> =
        Some(crate::runtime::qrcode::version::Version::V35);
    const LEVEL: Option<crate::runtime::qrcode::ecl::ECL> =
        Some(crate::runtime::qrcode::ecl::ECL::H);
    ...
    if let crate::runtime::qrcode::QRCode::V35(mat) = q {
        let l = mat.len();
        #[rustfmt::skip]
        let tmp = [
                mat[l - 1][8], mat[l - 2][8], mat[l - 3][8], mat[l - 4][8], mat[l - 5][8], mat[l - 6][8], mat[l - 7][8],
